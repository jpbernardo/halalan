...
<table cellpadding="0" cellspacing="0" border="0" class="form_table" width="100%">
    ...
    <tr>
		<td class="w20" align="right">
			<?php echo form_label(e('admin_election_last_name') . ':', 'last_name'); ?>
		</td>
		<td>
			<?php echo form_input('last_name', set_value('last_name', $admin['last_name']), 'id="election" maxlength="63" class="text"'); ?>
		</td>
	</tr>
    <tr>
		<td class="w20" align="right">
			<?php echo form_label(e('admin_election_first_name') . ':', 'first_name'); ?>
		</td>
		<td>
			<?php echo form_input('first_name', set_value('first_name', $admin['first_name']), 'id="election" maxlength="63" class="text"'); ?>
		</td>
	</tr>
    <tr>
		<td class="w20" align="right">
			<?php echo form_label(e('admin_election_username') . ':', 'username'); ?>
		</td>
		<td>
			<?php echo form_input('username', set_value('username', $admin['username']), 'id="election" maxlength="63" class="text"'); ?>
		</td>
	</tr>
    <tr>
		<td class="w20" align="right">
			<?php echo form_label(e('admin_election_email') . ':', 'email'); ?>
		</td>
		<td>
			<?php echo form_input('email', set_value('email', $admin['email']), 'id="election" maxlength="63" class="text"'); ?>
		</td>
	</tr>
	<tr>
		<td class="w20" align="right">
